...
public class CrimeListFragment extends Fragment {
    ...
    private static final String ARG_ISSUBTITLEVISIBLE = "ISSUBTITLE_VISIBLE";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mIsSubtitleVisible = getArguments().getBoolean(ARG_ISSUBTITLEVISIBLE);

        }

        if (savedInstanceState != null) {
            mIsSubtitleVisible = savedInstanceState.getBoolean(ARG_ISSUBTITLEVISIBLE);
    ...
    public void onSaveInstanceState(@NonNull final Bundle outState) {
        ...
        outState.putBoolean(ARG_ISSUBTITLEVISIBLE, mIsSubtitleVisible);
    ...
    private void updateUI() {
        ...
        if (mCrimeAdapter == null) {
            ...
            mCrimeAdapter = new CrimeAdapter(CrimeLab.getInstance(Objects.requireNonNull(getActivity()).getApplicationContext()).getCrimes());
            ...
            mCrimeAdapter.setItems(CrimeLab.getInstance(Objects.requireNonNull(getActivity()).getApplicationContext()).getCrimes());
    ...
    private void updateSubtitle() {
        int size = CrimeLab.getInstance(getActivity()).getCrimes().size();
    ...
    private class CrimeAdapter extends RecyclerView.Adapter<BaseCrimeHolder> {
        ...
        private List<Crime> mItems;


        CrimeAdapter(final List<Crime> items) {
            mItems = items;
        }
